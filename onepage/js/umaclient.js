...
var umaWeibo = {
	...
	post : function() {
		...
		var apiURL = $.trim(arguments[1]);
		var params = umaWeibo.params(arguments[2]);
		var muti   = (arguments[3] == undefined || arguments[3] == 0) ? 0 : 1;
		var callback = this.callback;
...
var umaImage = {
	...
	alphaPng : function(text, imgWidth, imgHeight, fontFamily, fontSize, fontColor) {
		var callback = this.callback;
		$.ajax({
			url : umaImage.serviceURL + '?method=alphaPng&argument1=' + text + '&argument2=' + imgWidth + '&argument3=' + imgHeight + '&argument4=' + fontFamily + '&argument5='
